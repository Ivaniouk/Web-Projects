$(document).ready( function(){
	...
	$("#FuelButton").click(function(){
		...
		if(numberValidator(Evelocity)){
			$('#fuelBreakOrbit').html("Error");
			$('#fuelLowOrbit').html("Error");
		}
		else{
	...
	//input check
	$("#Evelocity, #DeltaV, #AccelerationG, #DistanceTotal").on('input', function(){ //change JQ
	...
	$("#TotalButton").click(function(){
		...
		if(numberValidator(DeltaV) || numberValidator(AccelerationG) || numberValidator(DistanceTotal)){
			$('#AccTimeOut').html("Error");
			$('#AccTimeTotalOut').html("Error");
			$('#TotalTimeOut').html("Error");
			$('#TotalFuelOut').html("Error");
			$('#TraveledBoostOut').html("Error");
			$('#CruiseTimeOut').html("Error");
			return;
		}
